 ...
 * @author Laborada
 */
public class RiddlerEnd extends javax.swing.JFrame {
   ...
   public void setStory() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RiddlerEnd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RiddlerEnd().setVisible(true);
            }
        });
    }
